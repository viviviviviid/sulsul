...
- 오른쪽 아래에는 평소 **현재 상태 버튼 하나**가 반투명하게 보입니다. 커서를 올리거나 키보드로 포커스하면 선명해지면서 **원문 · 종료 · 일시중지/이어 읽기**가 펼쳐집니다.
- 오류는 버튼 위 말풍선에 표시되며 **다시 시도**를 한 번 눌러 재개할 수 있습니다.
...
- 현재 화면의 글을 작은 묶음으로 우선 요청합니다. 전체 탭에서 최대 두 요청을 동시에 실행하고 먼저 끝난 번역부터 표시합니다.
