...
**ChatGPT로 웹페이지를 읽던 자리에서 자연스럽고 쉬운 한국어로 읽으세요.**
...
- 우클릭 → 술술 번역 또는 **Alt + Shift + K**. Mac은 **Option + Shift + K**.
...
번역 대상 텍스트, 주변 문맥, 페이지 제목·주소는 OpenAI로 전달됩니다. 인증은 이 PC의 공식 Codex가 관리하며 확장은 비밀번호나 토큰을 받지 않습니다. 번역 결과는 Chrome 프로필에 저장하고 팝업에서 지울 수 있습니다. [개인정보 안내](PRIVACY.md).
