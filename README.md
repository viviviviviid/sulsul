...
고정 지침을 압축하고 짧은 메뉴·제목을 최대 24개씩 묶어 전송합니다. 캐시를 채우기 위한 별도 AI 요청은 하지 않습니다. API의 캐시 지원 조건이 구독 한도 절감률을 보장하지는 않습니다. [OpenAI 입력 캐시 문서](https://developers.openai.com/api/docs/guides/prompt-caching)
