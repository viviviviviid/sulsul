...
export class CodexConnection extends EventEmitter {
  ...
  async initialize(){await this.request('initialize',{clientInfo:{name:'sulsul',title:'술술',version:'0.14.0'}});this.child.stdin.write(JSON.stringify({method:'initialized',params:{}})+'\n');}
